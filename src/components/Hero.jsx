      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            A Freelance UI/UX Designer.<br className='sm:block hidden' />
           <p className={`text-[20px] mt-2 text-white-100`}>I help companies to design intuitve digital products and websites.</p> 
          </p>
        </div>
      </div>
      <StarsCanvas />
